	...
	<div class="col-md-12" style="margin-top: 15px;">
		...
		<div class="row">
			<!-- <div class="col-md-12">
				<button type="button" data-toggle="modal"
					data-target="#oldKRAModalSecond" ng-click="getOldKRAData()"
					...
					<tbody>
						...
						<tr ng-repeat="choice in sectionAList track by $index">
							...
							<td class="tooltip1"><textarea rows="4" cols="50"
									...
									ng-disabled=" loggedUserAppraisalDetails.initializationYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0 "></textarea>
									<span class="tooltiptext1" ng-if="choice.smartGoal != null" >{{choice.smartGoal}}</span></td></td>
							<td class="tooltip1"><textarea rows="4" cols="50"
							...
							<td><input type="date" class="form-control input-sm"
								...
								ng-disabled=" loggedUserAppraisalDetails.initializationYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0 "></td>
							<td><input type="text" class="form-control input-sm"
								ng-model="choice.weightage" ng-change="countWeightage()"
								style="text-align: center; height: 86px;"
								ng-disabled=" loggedUserAppraisalDetails.initializationYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0 "
								numbers-only maxlength="2"></td>
							<td class="tooltip1"><textarea rows="4" cols="50"
									class="form-control input-sm"
									ng-model="choice.midYearAchievement"
									ng-disabled="loggedUserAppraisalDetails.midYear == null ||  loggedUserAppraisalDetails.midYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0 || choice.weightage === null"></textarea>
							...
							<td><select class="form-control input-sm"
								...
								ng-disabled="loggedUserAppraisalDetails.midYear == null ||  loggedUserAppraisalDetails.midYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0 || choice.weightage === null"></select></td>
							<td><select class="form-control input-sm"
							...
							<td class="tooltip1"><textarea rows="4" cols="50"
									...
									ng-disabled="loggedUserAppraisalDetails.finalYear == null ||  loggedUserAppraisalDetails.finalYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0 || choice.weightage === null"></textarea>
							...
							<td><select class="form-control input-sm"
								...
								ng-options="item for item in selectsRating"
								ng-disabled="loggedUserAppraisalDetails.finalYear == null ||  loggedUserAppraisalDetails.finalYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0 || choice.weightage === null"></select></td>
							<td><select class="form-control input-sm"
							...
							<!-- <td><span ng-if="choice.finalYearAppraisarRating!=null">{{((choice.midYearSelfRating
									* 30/100) + (choice.finalYearSelfRating *70/100))/100 | number: 2 }}</span></td>
							<td><span ng-if="choice.finalYearAppraisarRating!=null">{{((choice.midYearAppraisarRating
									* 30/100) + (choice.finalYearAppraisarRating *70/100))/100 | number: 2 }}</span></td>
						...
						class="tooltiptext1">{{choice.midYearAssessmentRemarks}}</span></td>
							...
							<td><select class="form-control input-sm"
								...
								ng-disabled="loggedUserAppraisalDetails.finalYear == null ||  loggedUserAppraisalDetails.finalYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0 || choice.weightage === null"></select></td>
							<td><select class="form-control input-sm"
								style="height: 86px;" ng-model="choice.finalYearAppraisarRating"
								ng-style="choice.finalYearHighlights === 0 && {'color':'black'}  || choice.finalYearHighlights === 1 && {'color':'green','font-weight': '900'}"
								ng-options="item for item in selectsRating"
								ng-disabled="loggedUserAppraisalDetails.finalYear == null ||  loggedUserAppraisalDetails.finalYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0 || choice.weightage === null"></select></td>
							<td class="tooltip1"><textarea rows="4" cols="50"
						...
						<tr data-ng-repeat="choice in sectionCList track by $index">
							<!-- loggedUserAppraisalDetails.midYear == null ||  -->
							<td ng-if="$index =='0'"><i
								class="fa fa-plus btn plus-button"
								style="border: 2px solid lightgray;"
								ng-disabled=" loggedUserAppraisalDetails.initializationYear == 0 || kraButtonDisabled"
						...
						<tr data-ng-repeat="choice in sectionDList track by $index">
							...
							<td class="tooltip1"><textarea rows="4" cols="50"
									class="form-control input-sm"
									ng-model="choice.midYearAchievement"
									ng-disabled="loggedUserAppraisalDetails.midYear == null ||  loggedUserAppraisalDetails.midYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0"></textarea>
									<span class="tooltiptext1" ng-if="choice.midYearAchievement != null">{{choice.midYearAchievement}}</span></td>
							<td><select class="form-control input-sm"
								ng-model="choice.midYearSelfRating" style="height: 86px;"
								ng-options="item for item in selectsRating"
								ng-disabled="loggedUserAppraisalDetails.midYear == null ||  loggedUserAppraisalDetails.midYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0"></select></td>
							<td><select class="form-control input-sm"
								ng-model="choice.midYearAppraisarRating" style="height: 86px;"
								ng-style="choice.midYearHighlights === 0 && {'color':'black'}  || choice.midYearHighlights === 1 && {'color':'green','font-weight': '900'}"
								ng-options="item for item in selectsRating"
								ng-disabled="loggedUserAppraisalDetails.midYear == null ||  loggedUserAppraisalDetails.midYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0"></select>
							</td>
							<td class="tooltip1"><textarea rows="4" cols="50"
									class="form-control input-sm"
									ng-model="choice.midYearAssessmentRemarks"
						...
						class="tooltiptext1" ng-if="choice.midYearAssessmentRemarks != null">{{choice.midYearAssessmentRemarks}}</span></td>
							<td class="tooltip1"><textarea rows="4" cols="50"
									class="form-control input-sm"
									ng-model="choice.finalYearAchievement"
									ng-disabled="loggedUserAppraisalDetails.finalYear == null ||  loggedUserAppraisalDetails.finalYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0"></textarea>
									<span class="tooltiptext1" ng-if="choice.finalYearAchievement != null">{{choice.finalYearAchievement}}</span></td>
							<td><select class="form-control input-sm"
								ng-model="choice.finalYearSelfRating" style="height: 86px;"
								ng-options="item for item in selectsRating"
								ng-disabled="loggedUserAppraisalDetails.finalYear == null ||  loggedUserAppraisalDetails.finalYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0"></select></td>
							<td><select class="form-control input-sm"
								style="height: 86px;" ng-model="choice.finalYearAppraisarRating"
								ng-style="choice.finalYearHighlights === 0 && {'color':'black'}  || choice.finalYearHighlights === 1 && {'color':'green','font-weight': '900'}"
								ng-options="item for item in selectsRating"
								ng-disabled="loggedUserAppraisalDetails.finalYear == null ||  loggedUserAppraisalDetails.finalYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0"></select>
							</td>
							<td class="tooltip1"><textarea rows="4" cols="50"
									class="form-control input-sm" ng-model="choice.remarks"
									ng-disabled="loggedUserAppraisalDetails.finalYear == null ||  loggedUserAppraisalDetails.finalYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0"></textarea>
			...
			<div class="col-md-12" style="margin-top: 15px;">
				...
				<button type="button" ng-click="saveKRAModule('SAVE')" ng-hide="kraButtonSendToManager"
					ng-disabled="kraButtonDisabled || loggedUserAppraisalDetails == null" class="btn btn-outline-secondary">Save</button>
				<button type="button" ng-click="submitKRAModule('SUBMIT')"
					ng-hide="kraButtonSendToManager" ng-disabled="kraButtonDisabled || loggedUserAppraisalDetails == null"
					class="btn btn-outline-secondary">Submit</button>
				<button type="button" ng-click="saveKRAModule('SAVE')" ng-show="kraButtonSendToManager"
					ng-disabled="kraButtonDisabled " class="btn btn-outline-secondary">Save</button>
				<button type="button" ng-show="kraButtonSendToManager"
					ng-click="submitNewKRAModule('SUBMIT')"
					ng-disabled="kraButtonDisabled" class="btn btn-outline-secondary">Approved</button>
						...
						<tbody>
							<tr ng-repeat="choice in extraOrdinaryDetails"
								...
								<td><input type="text" class="form-control input-sm"
									...
									only-digits></td>
								<td><select class="form-control input-sm"
									style="height: 86px;" ng-model="choice.finalYearSelfRating"
									ng-options="item for item in selectsRating"
						...
						<tbody ng-repeat="x in formDataBC">
							<tr>
								...
								<td valign="bottom" align="center"><select
									...
									ng-options="item for item in selectsRating"
									ng-disabled="loggedUserAppraisalDetails.midYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0"></select></td>
								<td valign="bottom" align="center"><select
									class="form-control input-sm"
									...
									ng-options="item for item in selectsRating"
									ng-disabled="loggedUserAppraisalDetails.midYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0"></select>
								</td>
								<td valign="bottom" align="center"><select
									class="form-control input-sm" ng-model="x.finalYearSelfRating"
									ng-options="item for item in selectsRating"
									ng-disabled="loggedUserAppraisalDetails.finalYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0"></select></td>
								<td valign="bottom" align="center"><select
									class="form-control input-sm"
									...
									ng-options="item for item in selectsRating"
									ng-disabled="loggedUserAppraisalDetails.finalYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0"></select>
								</td>
							...
							<tr>
								<td colspan="9"
									style="webkit-box-shadow: 0 8px 6px -6px black; -moz-box-shadow: 0 8px 6px -6px black; box-shadow: 0 7px 6px -6px black;"><textarea
										...
										ng-disabled=" loggedUserAppraisalDetails.midYear == 0 || loggedUserAppraisalDetails.secondLevelIsvisible == 0"></textarea></td>
							</tr>
							<tr>
								<td colspan="9"
		...
		<div class="row" style="margin-top: 15px;">
			<form class="form-horizontal" role="form">
				<div class="col-md-4">
					<div>
						<!-- ng-disabled="loggedUserAppraisalDetails.secondLevelIsvisible == 0 || employeeCareerAspirationDetails.isValidatedBySecondLevel == 1" -->
						<textarea disabled
					...
					<div>
						<label class="control-label">Appraiser Review :</label>
					</div>
					<div>
						<textarea
				...
				<div class="col-md-4">
					<div>
						<!-- ng-disabled="employeeCareerAspirationDetails.midYearCommentsStatusSecondLevel === 1" -->
						<textarea disabled
					...
					<div
						ng-if="loggedUserAppraisalDetails.midYear ==1 || loggedUserAppraisalDetails.finalYear == 1 || employeeCareerAspirationDetails.midYearComments !=null">
						<label for="empCode" class="control-label">Appraiser Mid
							Year Review :</label>
					</div>
					<div>
						<textarea
							ng-model="employeeCareerAspirationDetails.midYearCommentsManagerReview"
							ng-if="loggedUserAppraisalDetails.midYear ==1 || loggedUserAppraisalDetails.finalYear == 1 || employeeCareerAspirationDetails.midYearComments"
							rows="10" style="width: 90%;"
							ng-disabled="employeeCareerAspirationDetails.midYearCommentsStatusSecondLevel === 1  || loggedUserAppraisalDetails.finalYear == 1"
							placeholder="Career aspirations of employee (to be filled in by employee but to be supported by the Superior in context to the Organization and Department.">
					</textarea>
					</div>
				...
				<div class="col-md-4">
					<div>
						<!-- ng-disabled="employeeCareerAspirationDetails.yearEndCommentsStatusSecondLevel === 1" -->
						<textarea disabled
		...
		<div class="row">
					...
					<table border="1" width="100%">
						...
						<tbody>
							<tr ng-repeat="choice in trainingNeedsDetails">
								<th>{{$index+1}}</th>
								<!-- ng-disabled=" trainingNeedsButtonDisabled || choice.isValidatedBySecondLevel ==1"></textarea></td> -->
								<td><textarea rows="4" cols="50"
										class="form-control input-sm" ng-model="choice.trainingTopic"
										disabled>
										</textarea></td>
								<td>
									<!-- ng-disabled=" trainingNeedsButtonDisabled || choice.isValidatedBySecondLevel ==1" -->
			...
			<button type="button" ng-click="printSecondLevel()"
				class="btn btn-outline-secondary">
				<span class="glyphicon glyphicon-download-alt"></span> Print
			</button>

		</div> -->
		<div style="margin-top: 15px;" id="viewAppraisalSecondLevel">
				...
				<tr>
					...
					<tbody>
						...
						<tr ng-repeat="choice in sectionAList track by $index">
							...
							<td valign="top" class="tableText">{{choice.midYearAchievement}}
						</td>
							...
							<td><a ng-href={{choice.fileName}} style="color: red;"
								ng-if="choice.fileName != null">Download</a></td>
							<!-- <td align="center"><span ng-if="choice.finalYearAppraisarRating!=null">{{((choice.midYearSelfRating
									* 30/100) + (choice.finalYearSelfRating *70/100))/100 | number: 2 }}</span></td>
				...
				<table border="1" style="border-collapse: collapse;">
					...
					<tbody ng-repeat="x in formDataBC">
						<tr>
							...
							<!-- <td><span ng-if="x.finalYearAssessorRating!=null">{{(x.midYearAssessorRating
									* 30/100) + (x.finalYearAssessorRating *70/100) | number: 2 }}</span></td>
							<td><span ng-if="x.finalYearAssessorRating!=null">{{(x.weightage
									* ((x.midYearAssessorRating * 30/100) +
									(x.finalYearAssessorRating *70/100)))/100 | number: 2}}</span>
									</td> -->
							<td><span ng-if="x.midYearAssessorRating!=null">{{((x.midYearAssessorRating
									* x.weightage)/100) | number: 2 }}</span></td>
							<td><span ng-if="x.finalYearAssessorRating!=null">{{((x.weightage
		...
		<div class="form-group" style="margin-top: 15px;">
			...
			<button type="button" ng-click="submit('APPROVED')"
				ng-disabled=" loggedUserAppraisalDetails.finalYear == null ||
			 loggedUserAppraisalDetails.secondLevelIsvisible == 0"
...
<div id="oldKRAModalSecond" class="modal fade" role="dialog">
