...
<div class="row">
	<form class="form-horizontal" role="form" name="empForm"
		...
		<div style="margin-top: 10px;">
			<div class="col-md-12">
				<table border="1" width="100%">
					...
					<tr>
						<td><textarea class="form-control" rows="3" id="approvedByCommentsId" placeholder="Comments" disabled
		...
		<div class="col-md-12" style="margin-top: 10px;">
			<button type="submit" class="btn btn-outline-secondary" ng-disabled ="employeePromotionDetails[0].hrCheck == 1"
			...
			<button type="button" class="btn btn-outline-secondary" ng-disabled ="employeePromotionDetails[0].hrCheck == 1"
