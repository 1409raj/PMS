...
<div class="section-tag">
	...
	<span style="float:right;color:red;" ng-if="(employeePromotionDetails[0].hrCheck == null || employeePromotionDetails[0].hrCheck == 0) && employeePromotionDetails.length > 0">In Process</span>
	<span style="float:right;color:green;" ng-if="employeePromotionDetails[0].hrCheck == 1">Approved</span>
</div>
<div class="col-md-12" id="promotionAlert">{{message}}</div>
<div class="row">
	<div class="col-md-3">
	...
	<form class="form-horizontal" role="form" name="empForm"
		...
		<div style="margin-top: 10px;">
			<div class="col-md-12">
				<table border="1" width="100%">
					...
					<tr>
						<td class="tableText" width="50%">First Level Superior<textarea class="form-control" rows="3"
								id="firstLevelSuperiorCommentsId" ng-disabled="levelType == 'SECOND LEVEL EMPLOYEE'" placeholder="Comments"
								ng-model="firstLevelSuperiorComments">
								</textarea> <br> 
								<!-- <span ng-if="employeePromotionDetails[0].firstLevelSuperiorSignatureDate == null">Date : {{currentDate | date : "dd.MM.y" }}</span>
						...
						<td class="tableText" width="50%">Second Level Superior
						<textarea class="form-control" rows="3"
								id="secondLevelSuperiorCommentsId" ng-disabled="levelType == 'FIRST LEVEL EMPLOYEE'" placeholder="Comments"
								ng-model="secondLevelSuperiorComments">
								</textarea><br> 
								<!-- <span ng-if="employeePromotionDetails[0].secondLevelSuperiorSignatureDate == null"> Date : {{currentDate | date : "dd.MM.y" }}</span>
		...
		<div style="margin-top: 10px;">
			<div class="col-md-12">
				<table border="1" width="100%">
					<tr>
						<td class="tableText">HR Remarks</td>
					<tr>
						<td><textarea class="form-control" rows="3" id="hrCommentsId" placeholder="Comments"
								ng-model="hrComments" disabled>
								</textarea> <br></td>
					</tr>
					<!-- <tr>
						<td>
							<p class="tableText">HR Signature</p> <textarea class="form-control"
								rows="3" id="hrSignatureId" ng-model="hrSignature" disabled>
								</textarea>
					...
					<!-- <tr>
						<td>
							...
							<p class="tableText">Signature</p> <textarea class="form-control"
								...
								ng-model="approvedBySignature" disabled>
								</textarea>
		...
		<div div class="col-md-12" style="margin-top: 10px;">
			<button type="submit" class="btn btn-outline-secondary" ng-if="levelType == 'FIRST LEVEL EMPLOYEE'"
			    ng-disabled ="employeePromotionDetails[0].firstLevelCheck == 1"
				style="align: left; float: left;" id="saveEmployeePromotion"
				data-loading-text="<i class='fa fa-spinner fa-spin '></i> Submitting">
				<spring:message code="button.save" />
			</button>
			<button type="submit" class="btn btn-outline-secondary" ng-if="levelType == 'SECOND LEVEL EMPLOYEE'"
			    ng-disabled ="employeePromotionDetails[0].secondLevelCheck == 1 "
				style="align: left; float: left;" id="saveEmployeePromotion"
				data-loading-text="<i class='fa fa-spinner fa-spin '></i> Submitting">
				<spring:message code="button.save" />
			</button>
			<button type="button" class="btn btn-outline-secondary" ng-click="rejectEmployeePromotion()" 
			    ng-disabled ="employeePromotionDetails[0].secondLevelCheck == 1" 
			    ng-if="levelType == 'SECOND LEVEL EMPLOYEE'"
				style="float: left;margin-left: 5px;" id="rejectEmployeePromotion"
				data-loading-text="<i class='fa fa-spinner fa-spin '></i> Submitting">
