...
@Entity
@Table(name = "kra_details")

public class KraDetails implements Cloneable{
	@Id
	@GeneratedValue
	@Column(name="ID")
	private Integer id;
	...
	public String toString() {
		return "KraDetails [id=" + id + ", empCode=" + empCode + ", appraisalYearId=" + appraisalYearId
				+ ", sectionName=" + sectionName + ", smartGoal=" + smartGoal + ", target=" + target + ", fileName="
				+ fileName + ", fileDummyName=" + fileDummyName + ", departmentName=" + departmentName
				+ ", designationName=" + designationName + ", empName=" + empName + ", achievementDate="
				+ achievementDate + ", weightage=" + weightage + ", midYearAchievement=" + midYearAchievement
				+ ", midYearSelfRating=" + midYearSelfRating + ", midYearAppraisarRating=" + midYearAppraisarRating
				+ ", midYearAssessmentRemarks=" + midYearAssessmentRemarks + ", finalYearAchievement="
				+ finalYearAchievement + ", finalYearSelfRating=" + finalYearSelfRating + ", finalYearAppraisarRating="
				...
				+ ", midYearHighlights=" + midYearHighlights + ", finalYearHighlights=" + finalYearHighlights
				+ ", kraType=" + kraType + "]";
	}
